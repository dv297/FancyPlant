...
import { BrandColorPalette } from "../../src/colors";
...
export default {
  ...
  // Color
  brandPrimary: BrandColorPalette.primary,
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  get toolbarDefaultBg() {
    return platform === PLATFORM.IOS
      ? "#F8F8F8"
      : BrandColorPalette.navigationBackgroundColor;
  },
  ...
  get toolbarBtnTextColor() {
    return platform === PLATFORM.IOS
      ? "#007aff"
      : BrandColorPalette.navigationTextColor;
  },
  ...
  titleFontColor:
    platform === PLATFORM.IOS ? "#000" : BrandColorPalette.navigationTextColor,
